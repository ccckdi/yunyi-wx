// 以下是业务服务器API地址
// 本机开发时使用
 var WxApiRoot = 'http://localhost:9201/yunyi-portal/';
// 局域网测试使用
// var WxApiRoot = 'http://192.168.1.3:8080/wx/';
// 云平台部署时使用
// var WxApiRoot = 'http://121.43.134.153:8080/wx/';
// 云平台上线时使用
// var WxApiRoot = 'https://jimeidaxue.top/wx/';

module.exports = {
  IndexUrl: WxApiRoot + 'home/index', //首页数据接口
  RecommendList: WxApiRoot + 'recommend/doRecommend', //推荐数据
  ...
  AuthRegisterCaptcha: WxApiRoot + 'auth/getAuthCode', //获取验证码
  ...
  RegionList: WxApiRoot + 'address/region', //获取区域列表

  OrderSubmit: WxApiRoot + 'order/submit', // 提交订单
  OrderPrepay: WxApiRoot + 'order/prepay', // 订单的预支付会话
  OrderAliPay: WxApiRoot + 'order/aliPay', // 支付宝支付
