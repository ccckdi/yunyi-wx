...
Page({
  ...
  getOrderDetail: function() {
    ...
    util.request(api.OrderDetail, {
      ...
      if (res.code === 200) {
        //格式化时间
        //res.data.orderInfo.createTime = util.formatTime(res.data.orderInfo.createTime);
  ...
  payOrder: function() {
    ...
    util.request(api.OrderPrepay, {
      ...
      if (res.code === 200) {
        var payUrl = 'http://4628b9j619.zicp.vip/yunyi-portal/order/aliPay?orderSn=' + res.data;
